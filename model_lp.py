...
def LPmodel(Nmachines, Njobs, p, s, b, h, penalty = 1):
    ...
    x = model.addVars(machines, jobs0, jobs0, vtype = GRB.CONTINUOUS, name = "x")
    # job j on machine i
    y = model.addVars(machines, jobs0, vtype=GRB.CONTINUOUS, name = "y")
    # completion time
